...
namespace MSAApplication.Migrations
{
    ...
    [Migration("20250726205858_AddChatMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSAApplication.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SkillSwapRequestId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SkillSwapRequestId", "SentAt");
            ...
            modelBuilder.Entity("MSAApplication.Models.ChatMessage", b =>
                {
                    b.HasOne("MSAApplication.Models.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MSAApplication.Models.SkillSwapRequest", "SkillSwapRequest")
                        .WithMany()
