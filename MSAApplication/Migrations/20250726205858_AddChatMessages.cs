        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillSwapRequestId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_SkillSwapRequests_SkillSwapRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_SkillSwapRequestId_SentAt",
                table: "ChatMessages",
                columns: new[] { "SkillSwapRequestId", "SentAt" });
        }
